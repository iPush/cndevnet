...
一个国内开发者可能有点用的网络工具，cndevnet 帮助开发者，尤其是初学者不用再费心折腾 pip/npm/golang/flutter/android/blockchain 等等无法访问的问题。
...
**重要：**资源有限，为了防止滥用，cndevnet 的密钥**每天会在北京时间 0 点重新生成**，如果希望继续使用，请在使用前，从 GitHub 拉取最新的代码来获取正确的密钥。

## 安装

### 准备

* Docker (如果你对 Docker 还不太熟悉，可以参考这里安装 [Docker+Docker Compose](https://docs.docker.com/engine/install/debian/))
...
注释其它内容，添加本地 127.0.0.1 的域名解析服务器
